...
public class AopOperLog extends BaseController{
	...
	//@Pointcut("execution(public * com.luoxi.controller.*.*(..))")
	@Pointcut("@annotation(com.luoxi.aop.ApiOperLog) && !execution(public * com.luoxi.controller.OperLogController.*(..))")
