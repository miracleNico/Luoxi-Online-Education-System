package com.ailoxi.client.vision.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //指定包下RequestHandlerSelectors.basePackage("com.luoxi.controller")
                //带注解RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class)
                //多包
                //.apis(basePackage("com.luoxi.controller;com.luoxi.base"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("wanbo","","wanbo@ailoxi.com"))
                .version("1.0")
                .build();
    }
