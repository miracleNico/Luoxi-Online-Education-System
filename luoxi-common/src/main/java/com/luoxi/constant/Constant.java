...
public class Constant {
	...
	//积分兑换比率(10分钟=1积分)
	@Value("${lx.custom.score.learningMinutes_convert_score:10}")
	private Long learningMinutes_convert_score;
	
	//日累计积分上限
	@Value("${lx.custom.score.day_max_convert_score:20}")
